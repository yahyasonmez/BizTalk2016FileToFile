namespace BTS2016FileToFile {
    ...
    [Schema(@"http://BTS2016.com.tr/FileToFile",@"Book")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"Book"})]
  ...
  <xs:element name=""Book"">
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element minOccurs=""1"" maxOccurs=""1"" name=""AuthorFirstName"" type=""xs:string"" />
        <xs:element minOccurs=""1"" maxOccurs=""1"" name=""AuthorLastName"" type=""xs:string"" />
      </xs:sequence>
    </xs:complexType>
  </xs:element>
</xs:schema>";
